...
<head>
  ...
  <title>Edit Passenger data</title>
  <style>
    body {
...
<body>
  ...
  <form action="./edit.php" method="post" enctype="multipart/form-data">
    ...
    <input type="text" id="pname" name="pname" placeholder="Enter Your name" value="<?php echo $_POST['pname'] ?>"
      required />
    <br />

    <label for="pnum">Number</label>
    <input type="number" id="pnum" name="pnum" placeholder="Change Ticket Number" value="<?php echo $_POST['pnum'] ?>"
      required />
    <br />
